...
public class Massiivid {
    //Koosta funktsioon, mis tagastab kaheelimendilise massiivi,
    ...
    public static int[] piirid(int[] arvud){
        ...
        if(arvud==null){
            throw new RuntimeException("parametri väärtus null");
        }
        if(arvud.length==0){
            throw new RuntimeException("parametriks tühi massiiv");
        }
